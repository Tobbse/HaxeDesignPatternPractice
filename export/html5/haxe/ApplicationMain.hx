...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeDesignPatternPractice", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeDesignPatternPractice", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "13";
		app.meta["company"] = "";
		app.meta["file"] = "HaxeDesignPatternPractice";
		app.meta["name"] = "HaxeDesignPatternPractice";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "HaxeDesignPatternPractice",
			width: 0,
			x: null,
			y: null,
		};
